  ...
  return (
    <div>
         ...
         <div className='text-center  md:ml-0  mt-2'>
          <input type="text" onChange={handlechange} className='border border-black p-2 rounded-xl md:w-[30vw] w-[80vw] md:pl-5 pl-10' name='name' placeholder='Enter your full name' />
         </div>
         {/* Email details */}
         <div>
         ...
         <div className='text-center  md:ml-0  mt-2'>
          <input type="text" name='email' onChange={handlechange} className='border border-black p-2 rounded-xl md:w-[30vw] w-[80vw] md:pl-5 pl-10' placeholder='name@example.com' />
         </div>
         {/* Password details */}
         <div>
         ...
         <div className='text-center  md:ml-0  mt-2'>
          <input type="password" name='password' onChange={handlechange} className='border border-black p-2 rounded-xl md:w-[30vw] w-[80vw] md:pl-5 pl-10' placeholder='Create a strong password' />
         </div>
         <div className='text-center mt-10'>
          <button onClick={handlesignup} className='bg-blue-600 cursor-pointer rounded-xl hover:bg-blue-900 active:md:w-[60vh] active:w-[40vh] transition-all ease-in md:w-[65vh] font-bold text-white py-2 w-[45vh]'>Sign Up</button>
         </div>
         <div className='flex mt-1 gap-2 justify-center'>
             <h1 className='text-gray-500'>Already have an account?</h1>
             <a href='#login' className='text-blue-500 font-bold cursor-pointer'>Login</a>
         </div>
         <div className='flex justify-center'>
